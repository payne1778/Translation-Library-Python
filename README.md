...
### TL-PYTHON OPERATIONAL STATUS: _Borked, but almost working_

> [!NOTE]
> I am currently working on a massive overhaul with the TL Python implementation.
> Conversion to an offical Python package, reconstruction the CLI, and implementation with feature-rich libraries are underway.
> For right now, expect the documentation to be out-of-date and code to be non-functional.
